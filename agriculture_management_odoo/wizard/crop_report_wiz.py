...
class CropReport(models.TransientModel):
    ...
    def action_pdf_report(self):
        ret = """select crop_requests.ref, res_partner.name, 
                    ...
                    inner join vet_details ON 
                    crop_requests.veterinario_id = vet_details.id
                    inner join animal_details ON 
                    crop_requests.animal_id = animal_details.id
                    inner join res_partner ON
                    vet_details.vet_name = res_partner.id
