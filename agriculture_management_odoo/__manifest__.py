...
#############################################################################
{
    ...
    'data': [
        ...
        'report/crop_report_template.xml',
         'report/crop_states_report_template.xml',
        'report/crop_states_report.xml',
        'report/crop_animal_report_template.xml',
       ...
       'views/location_details_view.xml',
        ...
        'views/animales_sintoms_eventos.xml',
       # # 'views/res_partner.xml',
       #  'views/animal_rental_views.xml',

    ],
    'css': [
        'static/src/css/estilo.css',
    ],
